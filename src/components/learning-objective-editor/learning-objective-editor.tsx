...
import { Target, ArrowDown, ArrowUp, GripVertical, Plus, Save } from "lucide-react";
import { forwardRef, useState } from "react";

import { cn } from "../../lib/cn.js";
import type { LearningObjectiveDraft, LearningObjectiveEditorProps } from "./learning-objective-editor.types.js";

const DEFAULT_ITEMS: LearningObjectiveDraft[] = [
  {
    "id": "o1",
    "title": "Students will compare renewable and nonrenewable resources",
    "detail": "Measured with a two-paragraph explanation and source evidence.",
    "tag": "specific"
  },
  {
    "id": "o2",
    "title": "Students will solve multistep ratio problems",
    "detail": "Measured by an 80 percent score on the independent practice set.",
    "tag": "measurable"
  },
  {
    "id": "o3",
    "title": "Students will revise claims using peer feedback",
    "detail": "Measured in the final seminar reflection before Friday.",
    "tag": "time-bound"
  }
];
...
export const LearningObjectiveEditor = forwardRef<HTMLDivElement, LearningObjectiveEditorProps>((props, ref) => {
  const {
    title = "Learning Objective Editor",
    subtitle = "Structured planning surface for writing SMART objectives and aligning success criteria.",
    objectives = DEFAULT_ITEMS,
    primaryActionLabel = "Save objectives",
    disabled = false,
    onSaveObjectives,
    className,
    ...rest
  ...
  return (
    <div
      ...
      data-slot="learning-objective-editor"
      {...rest}
    >
        ...
        <aside className="rounded-2xl border border-border bg-muted/10 p-4 sm:p-5">
          <div className="space-y-3">
            ...
            <button
              type="button"
              disabled={disabled}
              onClick={() => onSaveObjectives?.(items)}
...
LearningObjectiveEditor.displayName = "LearningObjectiveEditor";
