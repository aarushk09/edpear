  ...
  (
    ...
    return (
      <a
        ref={ref}
        className={cn(
          "group flex flex-col overflow-hidden rounded-3xl border bg-card text-card-foreground shadow-sm transition-transform duration-200",
      ...
      >
        <div className="relative aspect-[16/9] overflow-hidden bg-muted">
          ...
          <div className="absolute left-4 top-4 flex gap-2">
            {categoryTag ? (
              <span className="rounded-full bg-background/85 px-3 py-1 text-xs font-semibold text-foreground backdrop-blur">
                {categoryTag}
              </span>
            ) : null}
            {status ? (
