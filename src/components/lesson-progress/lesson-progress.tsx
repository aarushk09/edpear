...
export const LessonProgress = forwardRef<HTMLDivElement, LessonProgressProps>(
  ({ steps, currentStep = 0, showLabels = true, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn("space-y-4 rounded-3xl border bg-card p-5 text-card-foreground", className)}
                ...
                <div className="flex flex-col items-center gap-2">
                  <span
                    ...
                    className={cn(
                      ...
                      state === "complete" &&
                        "border-progress bg-progress text-primary-foreground shadow-sm",
                  ...
                  {index < steps.length - 1 ? (
                    <span
                      ...
                      className={cn(
                        ...
                        index < safeCurrentStep ? "bg-progress" : "bg-border",
                      )}
                    />
                  ) : null}
                </div>
