...
import { Shuffle, ArrowDown, ArrowUp, GripVertical, Plus, Save } from "lucide-react";
import { forwardRef, useState } from "react";

import { cn } from "../../lib/cn.js";
import type { QuestionVariantDraft, QuestionVariantManagerProps } from "./question-variant-manager.types.js";

const DEFAULT_ITEMS: QuestionVariantDraft[] = [
  {
    "id": "qv1",
    "title": "Core algebra set",
    "detail": "Shared stem with numeric coefficients shuffled per seat.",
    "tag": "parameterized"
  },
  {
    "id": "qv2",
    "title": "Reading evidence prompt",
    "detail": "Passage stays constant while evidence options rotate.",
    "tag": "shuffled"
  },
  {
    "id": "qv3",
    "title": "Lab analysis question",
    "detail": "Graph labels and data values vary by section.",
    "tag": "pooled"
  }
];
...
export const QuestionVariantManager = forwardRef<HTMLDivElement, QuestionVariantManagerProps>((props, ref) => {
  const {
    title = "Question Variant Manager",
    subtitle = "Variant planning surface for shuffling question pools and parameter sets per learner seat.",
    variants = DEFAULT_ITEMS,
    primaryActionLabel = "Save variants",
    disabled = false,
    onSaveVariants,
    className,
    ...rest
  ...
  return (
    <div
      ...
      data-slot="question-variant-manager"
      {...rest}
    >
...
QuestionVariantManager.displayName = "QuestionVariantManager";
