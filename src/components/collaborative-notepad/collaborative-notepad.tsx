...
import { NotebookText, ArrowDown, ArrowUp, GripVertical, Plus, Save } from "lucide-react";
import { forwardRef, useState } from "react";

import { cn } from "../../lib/cn.js";
import type { CollaborativeNote, CollaborativeNotepadProps } from "./collaborative-notepad.types.js";

const DEFAULT_ITEMS: CollaborativeNote[] = [
  {
    "id": "cn1",
    "title": "Key idea",
    "detail": "Plants use sunlight to store energy in glucose.",
    "tag": "summary"
  },
  {
    "id": "cn2",
    "title": "Question",
    "detail": "How is cellular respiration the reverse of photosynthesis?",
    "tag": "question"
  },
  {
    "id": "cn3",
    "title": "Example",
    "detail": "Leaf color changes can signal chlorophyll breakdown.",
    "tag": "example"
  }
];
...
export const CollaborativeNotepad = forwardRef<HTMLDivElement, CollaborativeNotepadProps>((props, ref) => {
  const {
    title = "Collaborative Notepad",
    subtitle = "Shared lesson-scoped notes surface with visible contributions and easy synthesis.",
    notes = DEFAULT_ITEMS,
    primaryActionLabel = "Save notes",
    disabled = false,
    onSaveNotes,
    className,
    ...rest
  ...
  return (
    <div
      ...
      data-slot="collaborative-notepad"
      {...rest}
    >
...
CollaborativeNotepad.displayName = "CollaborativeNotepad";
