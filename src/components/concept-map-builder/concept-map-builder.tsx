...
import { Share2, ArrowDown, ArrowUp, GripVertical, Plus, Save } from "lucide-react";
import { forwardRef, useState } from "react";

import { cn } from "../../lib/cn.js";
import type { ConceptMapNode, ConceptMapBuilderProps } from "./concept-map-builder.types.js";

const DEFAULT_ITEMS: ConceptMapNode[] = [
  {
    "id": "n1",
  ...
  },
  {
    "id": "n2",
    "title": "Chloroplast",
    "detail": "Site of the reaction",
    "tag": "place"
  },
  {
    "id": "n3",
    "title": "Glucose",
    "detail": "Primary product",
    "tag": "output"
  }
];
...
export const ConceptMapBuilder = forwardRef<HTMLDivElement, ConceptMapBuilderProps>((props, ref) => {
  const {
    title = "Concept Map Builder",
    subtitle = "Freeform node-link planning surface for learner-generated knowledge maps.",
    nodes = DEFAULT_ITEMS,
    primaryActionLabel = "Save map",
    disabled = false,
    onSaveNodes,
    className,
    ...rest
...
ConceptMapBuilder.displayName = "ConceptMapBuilder";
