...
import { Tags, ArrowDown, ArrowUp, GripVertical, Plus, Save } from "lucide-react";
import { forwardRef, useState } from "react";

import { cn } from "../../lib/cn.js";
import type { BloomsTaggedObjective, BloomsTaxonomyTaggerProps } from "./blooms-taxonomy-tagger.types.js";

const DEFAULT_ITEMS: BloomsTaggedObjective[] = [
  {
    "id": "b1",
    "title": "Define key ecosystem vocabulary",
    "detail": "Remember",
    "tag": "remember"
  },
  {
    "id": "b2",
    "title": "Compare two food webs",
    "detail": "Analyze",
    "tag": "analyze"
  },
  {
    "id": "b3",
    "title": "Design a habitat improvement plan",
    "detail": "Create",
    "tag": "create"
  }
];
...
export const BloomsTaxonomyTagger = forwardRef<HTMLDivElement, BloomsTaxonomyTaggerProps>((props, ref) => {
  const {
    title = "Blooms Taxonomy Tagger",
    subtitle = "Labels learning objectives across remember-to-create levels with curriculum-ready consistency.",
    objectives = DEFAULT_ITEMS,
    primaryActionLabel = "Save tagged objectives",
    disabled = false,
    onSaveObjectives,
    className,
    ...rest
  ...
  return (
    <div
      ...
      data-slot="blooms-taxonomy-tagger"
      {...rest}
    >
...
BloomsTaxonomyTagger.displayName = "BloomsTaxonomyTagger";
