...
import type { MoodCheckInEntry, MoodCheckInProps } from "./mood-check-in.types.js";

const DEFAULT_ITEMS: MoodCheckInEntry[] = [
  {
    "id": "mo1",
    "title": "Ready to focus",
    "subtitle": "Calm and prepared",
    "detail": "Best fit for independent practice or a short challenge task.",
    "status": "green",
    "tag": "steady",
    "evidence": [
  ...
  {
    "id": "mo2",
    "title": "Worried about the quiz",
    "subtitle": "Needs reassurance",
    "detail": "Confidence is low before timed checks, even when preparation is solid.",
    "status": "amber",
    "tag": "anxious",
    "evidence": [
      "Asked for extra review"
    ],
    "score": 3
  },
  {
    ...
    "subtitle": "Needs pacing support",
    "detail": "A lighter start and a shorter first task would reduce friction.",
    "status": "red",
    "tag": "overwhelmed",
    "evidence": [
      "Late arrival",
...
export const MoodCheckIn = forwardRef<HTMLDivElement, MoodCheckInProps>((props, ref) => {
  const {
    title = "Mood Check In",
    subtitle = "Session-start emotional check-in that logs learner mood and surfaces support needs early.",
    entries = DEFAULT_ITEMS,
    primaryActionLabel = "Log mood",
    secondaryActionLabel = "Support tip",
    disabled = false,
    onLogMood,
    onShareSupportTip,
    className,
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3 pt-1">
                <button
                  type="button"
                  disabled={disabled}
                  onClick={() => activeItem && onLogMood?.(activeItem)}
                ...
                <button
                  type="button"
                  disabled={disabled}
                  onClick={() => activeItem && onShareSupportTip?.(activeItem)}
