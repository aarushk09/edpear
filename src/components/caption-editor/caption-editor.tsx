...
import { FileText, ArrowDown, ArrowUp, GripVertical, Plus, Save } from "lucide-react";
import { forwardRef, useState } from "react";

import { cn } from "../../lib/cn.js";
import type { CaptionCueDraft, CaptionEditorProps } from "./caption-editor.types.js";

const DEFAULT_ITEMS: CaptionCueDraft[] = [
  {
    "id": "cc1",
    "title": "00:00 - 00:05",
    "detail": "Welcome back. Today we are comparing renewable and nonrenewable resources.",
    "tag": "intro"
  },
  {
    "id": "cc2",
    "title": "00:06 - 00:12",
    "detail": "Watch how the graph changes as demand increases over time.",
    "tag": "instruction"
  },
  {
    "id": "cc3",
    "title": "00:13 - 00:18",
    "detail": "Pause here if you want to annotate the diagram before moving on.",
    "tag": "prompt"
  }
];
...
export const CaptionEditor = forwardRef<HTMLDivElement, CaptionEditorProps>((props, ref) => {
  const {
    title = "Caption Editor",
    subtitle = "Editable timed transcript surface for keeping lesson captions accurate and learner-friendly.",
    cues = DEFAULT_ITEMS,
    primaryActionLabel = "Save captions",
    disabled = false,
    onSaveCues,
    className,
    ...rest
  ...
  const [items, setItems] = useState(cues);
...
CaptionEditor.displayName = "CaptionEditor";
